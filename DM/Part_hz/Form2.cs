...
namespace DM
{
    public partial class Form2 : Form
    {
        ...
        public string connectionString = "Data Source=" + Application.StartupPath + "\\m_sqlite.db;Version=3;";
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
            ...
            gcontrol_t_ios.DataSource = QueryIOInfomation(connectionString);
            id.FieldName = "id";
        ...
        /// <returns></returns>
        public DataTable QueryIOInfomation(string filepath)
        {
            ...
            {
                connection.Open();
                using (SQLiteCommand command = new SQLiteCommand("SELECT * FROM t_ios", connection))
                {
